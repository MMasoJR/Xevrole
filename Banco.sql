...
CREATE TABLE cargos (
    ...
    descricao TEXT -- Adicionando descrição do cargo
);
-- ============================
-- Tabela de Clientes
-- ============================
...
CREATE TABLE funcionarios (
    ...
    FOREIGN KEY (id_cargo) REFERENCES cargos(id_cargo)
        ON DELETE RESTRICT ON UPDATE CASCADE,  -- Restrição de deleção
    FOREIGN KEY (id_endereco) REFERENCES endereco(id_endereco)
        ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (id_contato) REFERENCES contato(id_contato)
        ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE pagamentos (
    ...
    id_venda INT NOT NULL,
    tipo_pagamento ENUM('dinheiro', 'cartão', 'boleto', 'transferência') NOT NULL,
...
-- ============================
INSERT INTO cargos (nome_cargo, salario_base, descricao) VALUES
('Vendedor', 2500.00, 'Responsável pelas vendas de produtos e atendimento aos clientes'),
('Gerente', 5000.00, 'Gerente de equipe e coordenador das operações diárias'),
('Atendente', 2000.00, 'Atendente no balcão, responsável pelo atendimento ao cliente'),
('Caixa', 2100.00, 'Responsável pelo fechamento de caixa e controle de pagamentos'),
('Supervisor', 4000.00, 'Supervisor de operações, com foco em treinamento e liderança de equipe');
-- ============================
...
('Qin Shi Huang', '45678901234', 4, 4, '2025-04-01'),
...
-- ============================
INSERT INTO vendas (id_cliente, id_funcionario, valor_total) VALUES
(1, 1, 400.00),
(2, 2, 900.00);
-- ============================
...
-- Inserindo pagamento
-- ============================
INSERT INTO pagamentos (id_venda, tipo_pagamento, valor_pago) VALUES
(1, 'cartão', 400.00),
(2, 'dinheiro', 900.00);
